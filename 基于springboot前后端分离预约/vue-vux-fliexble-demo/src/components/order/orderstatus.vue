                ...
                <div class="order-have-in-class" v-for="(item,index) in orderDetail" :key="index"  >
                            ...
                            <div class="order-header-frist-left">
                                ...
                                <div class="order-header-left">
                                    <span class="order-header-font-size">支付方式:
                                       &nbsp;&nbsp;&nbsp;<span v-if="item.orderDetailVoList[0].paymentType === 1">支付宝支付</span>
                                        <span v-if="item.orderDetailVoList[0].paymentType === 0">现金支付</span>
                                    </span>
                    ...
                    <div class="order-status-button">
                        <div class="order-button">
                            <x-button  @click.native="isReturnTicket(index)" type="primary" v-if="item.orderDetailVoList[0].orderStatus === 0">退预</x-button>
                             <x-button   type="disabled" v-if="item.orderDetailVoList[0].orderStatus === 2">退预</x-button>
                        </div>
                            <div v-transfer-dom>
        ...
        axios({
          ...
          params: {
            //  'openid':getCookie('openid')
               'openid':'oI5mNxN6SbZmLnVW15dOj6wrTlvo'
            //    'orderId':this.
          }
      }).then((response)=>{
